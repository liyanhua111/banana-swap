...
import TokenInstructionsSRM from "@project-serum/serum";
const TokenInstructions = TokenInstructionsSRM.TokenInstructions;
...
async function createMint(provider: any, authority: any) {
...
async function createTokenAccount(provider: any, mint: any, owner: any) {

...
export const AddToLiquidity = () => {
  ...
  const { A, B, setLastTypedAccount, setPoolOperation, options, setOptions } =
  ...
  const createPoolButton = pool && (
    ...
    >
      {generateActionLabel(
        i18n.language,
        CREATE_POOL_LABEL(i18n.language),
        connected,
        tokenMap,
        A,
        B
    ...
    >
      {depositType === "both"
        ? generateActionLabel(
            i18n.language,
            pool
              ? ADD_LIQUIDITY_LABEL(i18n.language)
              : CREATE_POOL_LABEL(i18n.language),
            connected,
            tokenMap,
            A,
      ...
      <div className="input-card">
        <div className="desBox">
          ...
          <div className="desR">
            ...
            <Popover
              trigger="hover"
              content={<div style={{ width: 300 }}>{t("LiquidityTip1")}</div>}
            >
              <QuestionCircleOutlined
      ...
      <Row style={{ width: "100%", padding: "0 12px" }}>
        <Col span={12} style={{ textAlign: "left" }}>
          ...
          <span className="font1">
            {Number(parseFloat(data[1].tokens).toFixed(2))}
          </span>
        </Col>
        <Col span={12} style={{ textAlign: "right" }}>
          {data[0].name}：
          <span className="font1">
            {Number(parseFloat(data[0].tokens).toFixed(2))}
          </span>
        </Col>
      </Row>
    </Card>

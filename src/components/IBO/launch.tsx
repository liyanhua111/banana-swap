...
import { Button, Card, Col, Row, Table, DatePicker, Tooltip } from "antd";
...
import { IBOCreate } from "../../utils/IBO/IBOInstructions";
    ...
    <div className="launch">
      ...
      <div className="tabBox">
        <p
          ...
          className={`tabTitle ${IBOType == "A" ? "tabActive" : ""}`}
        >
          定价众筹
        </p>
        <p
          ...
          className={`tabTitle ${IBOType == "B" ? "tabActive" : ""}`}
        >
          升价众筹
        </p>
      </div>
      <div className="subTitle">
        ...
        {connected && currency && (
          <p>
            余额：{currencyBalance}
            <span className="font3" onClick={MaxFunc}>
              Max
            </span>
          </p>
        )}
      ...
      <div className="inputItem inputItem2">
        ...
        <p className="valTip">
          {Number(tokenAmount) > 0 && Number(ratio) > 0
      ...
      <div className="inputItem inputItem2">
        <p className="label">目标筹集资金</p>
        <p className="valTip">
          {Number(tokenAmount) > 0 && Number(ratio) > 0 && Number(sellPrice) > 0
            ? new BigNumber(tokenAmount || 0)
                .times(sellPrice || 0)
                .times(ratio || 0)
                .div(100)
      ...
      <div className="subTitle marginT">
        <span>03 设置众筹参数</span>
      </div>
      <div className="inputItem">
        <p className="label">
      ...
      <div className="inputItem">
        ...
        {[30, 90, 180].map((item) => {
          return (
            <p
              onClick={() => {
                protectDaysChange(item);
              }}
              className={`btnSelect ${
                protectDays == item ? "btnSelectActive" : ""
              }`}
            >
              {item}天
            </p>
    ...
    <>
      ...
      <div className="launchPage">
        <div className="titleBox">
          <p>
            发起 <span className="font1">/ 发起众筹建池</span>
          </p>
        </div>
